...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect('categories')->with('status','Item edited successfully!');
    }
    ...
    public function destroy(Category $category)
    {
        try {
            $category->delete();
            return redirect('categories')->with('status','Item deleted successfully!')->with('type', 'success');
        }
        catch (\Exception $exception){
            return redirect('categories')->with('status',$exception->getMessage())->with('type', 'error');
        }
    }
}
